...
final videoMarkersProvider = FutureProvider.family<List<VideoMarker>, String>((ref, videoPath) async {
...
class MarkerActions {
  ...
  Future<void> updateMarker(String videoPath, VideoMarker marker) async {
    ...
    final updatedMarkers = currentMarkers.map((m) => m.id == marker.id ? marker : m).toList()
      ..sort((a, b) => a.timestamp.compareTo(b.timestamp));
