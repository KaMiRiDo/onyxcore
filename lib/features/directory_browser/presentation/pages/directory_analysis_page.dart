  ...
  Widget build(BuildContext context) {
    ...
    switch (type) {
      ...
      case FileItemType.video:
        config = FileIconConfig(Icons.movie_rounded, [
      ...
      case FileItemType.document:
        config = FileIconConfig(Icons.description_rounded, [
          ...
          child: Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text(
                  StringUtils.formatBytes(item.stat.size),
                  style: const TextStyle(
                    color: AppColors.textBody,
                    fontWeight: FontWeight.w600,
                  ),
              ...
              Expanded(
                flex: 1,
                child: Text(
                  _formatDate(item.stat.modified),
                  style: const TextStyle(
                    color: AppColors.textMuted,
                    fontSize: 13,
                  ),
